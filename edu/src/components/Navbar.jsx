...
const Navbar = () => {
    ...
    const signInClass = ({ isActive }) => isActive ? 'btn bg-black text-white hover:bg-gray-900 border-none' : 'btn bg-red-50 hover:bg-black hover:text-white transition duration-300 text-black border-none'
