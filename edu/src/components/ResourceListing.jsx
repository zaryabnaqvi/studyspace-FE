...
const ResourceListing = ({ resources }) => {
  ...
  return (
    <div
      className="bg-white rounded-xl shadow-md relative text-black hover:shadow-2xl transition duration-500"
      data-aos="fade"
    ...
    >
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="text-red-500 mb-5 hover:text-red-400 transition duration-200 text-xs"
        >
